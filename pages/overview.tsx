    ...
    <Layout pageTitle="Overview">
      <Section>
        <SectionContent>
          ...
          <p>CoW DAO Grants aim to issue rounds of grant funding on an application basis until the first CoW DAO installment has dried up.</p>

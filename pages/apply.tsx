...
<br/><br/>
            For more information, check out the COW Grants program overview to view judgment criteria for the applications.</p>
        
          <iframe src="https://airtable.com/embed/shre8N1jYv7kKynk1?backgroundColor=blue" frameBorder="0" width="100%" height="1719" className="airtable-embed airtable-dynamic-height"></iframe>
        </SectionContent>
      </Section>
    </Layout>
  )
